...
final class Version20190717210346 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "group" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, is_admin BOOLEAN NOT NULL)');
        ...
        $this->addSql('CREATE TABLE group_audit (id INTEGER NOT NULL, rev INTEGER NOT NULL, name VARCHAR(255) DEFAULT NULL, is_admin BOOLEAN DEFAULT NULL, revtype VARCHAR(4) NOT NULL, PRIMARY KEY(id, rev))');
        $this->addSql('CREATE INDEX rev_9790a06851c948e4a63d30a8d3b619c1_idx ON group_audit (rev)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE group_audit');
